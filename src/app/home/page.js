...
export default function HomePage() {
  return (
    <div className="flex justify-center  mb-10  flex-wrap  items-end  overflow-y-auto scrollbar scrollbar-thumb-black scrollbar-w-2 z-10 h-screen absolute top-0 w-screen">
       <Image priority
        src={myImageMobile}
